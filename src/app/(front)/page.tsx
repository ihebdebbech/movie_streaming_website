...
export default function Index() {
  return (
    <>
      ...
      <section
        id="features"
        className="container space-y-6  py-8 bg-transparent md:py-12 lg:py-24"
      >
        <div className="mx-auto flex bg-transparent max-w-[58rem] flex-col items-center space-y-4 text-center">
